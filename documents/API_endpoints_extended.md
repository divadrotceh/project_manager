...
flowchart TB
  ...
  subgraph fig2["Figure 2 - User and Project Flows"]
    ...
    b27(("Project Details")) --> b28["Auth Layer"]
    ...
    b35(("Update project")) --> b36["Auth Layer"]
    b36 --> b37["Auth Service"]
    b37 --> b41["Untitled Node"]
    b38["Project Service"] --> b39["PostgreSQL Controller"]
